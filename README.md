...
document.getElementById('submitBtn').addEventListener('click', function(){
  ...
  saveResult({ scores, leadingTypes, answers });
  showResults();
});
});
...
document.addEventListener('change', function(ev){
  ...
  <script>
    // TODO: вставьте свои данные Firebase ниже
    const firebaseConfig = {
  apiKey: "AIzaSyBrOsc_UnKjDeFyh4ZTg49ncp0EjZI7Bg8",
  authDomain: "psyotest.firebaseapp.com",
  projectId: "psyotest",
  storageBucket: "psyotest.firebasestorage.app",
  messagingSenderId: "1054437948182",
  appId: "1:1054437948182:web:e964dec5056b20ecdeee37",
  measurementId: "G-SBWN62G01P"
};
    ...
    async function saveResult(result) {
      try {
        await db.collection("personality_results").add({
          ...result,
